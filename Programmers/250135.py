...
def solution(h1, m1, s1, h2, m2, s2):
    ...
    for _ in range(total_seconds):
        after_sec_hourhand = round(hourhand + (1 / 120), 3)
        after_sec_minutehand = round(minutehand + (1 / 10), 3)
        after_sec_secondhand = secondhand + 6
        
        # if after_sec_secondhand == 360:
        #     if int(after_sec_hourhand) == after_sec_secondhand:
        #         answer -= 1
        #     if int(after_sec_minutehand) == after_sec_secondhand:
        #         answer -= 1
